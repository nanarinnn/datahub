    ...
    <nav className="w-full sticky top-0 z-50 backdrop-blur-xl bg-[#0a0d3a]/85 border-b border-[#5865f2]/20 px-3 sm:px-6 py-3 flex items-center justify-between max-w-6xl mx-auto shadow-lg shadow-[#0a0d3a]/60">
      ...
      <div className="flex items-center space-x-2">
        <button
          ...
          className={`flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl text-xs sm:text-sm font-extrabold transition-all duration-200 ${
            activeTab === 'devnotes'
        ...
        >
          <span>개발자 노트</span>
          <span className="px-1.5 py-0.2 rounded-full bg-[#35ed7e] text-black text-[10px] font-black animate-pulse">NEW</span>
        </button>
        <button
          onClick={handleHome}
          className="flex items-center gap-1.5 px-3 py-1.5 sm:py-2 rounded-xl bg-[#5865f2] hover:bg-[#4752c4] text-white text-xs sm:text-sm font-bold shadow-md shadow-[#5865f2]/30 active:scale-95 transition-all duration-200"
          title="홈으로"
        >
          <Home size={15} />
          <span>HOME</span>
